            ...
            <Navbar bg="" variant="light" className="justify-content-end navbar" sticky="top" collapseOnSelect expand="lg" >
                <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        ...
                        <a className="resume_button ms-3" href="https://drive.google.com/file/d/1HkEqoUAno93RCA_s_Cv9akdipmHulFVY/view" target="_blank"><i className="fas fa-cog fa-spin me-2"></i>My Resume</a>
